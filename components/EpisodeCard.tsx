...
const EpisodeCard: React.FC<EpisodeCardProps> = ({ episode, onPlay }) => {
  /*
    ...
    - WHAT: Wrapped EpisodeCard in React.memo and stabilized its onPlay callback.
    - WHY: Prevents all EpisodeCard instances from re-rendering when the global playback state (isPlaying) toggles in the parent Layout.
    - IMPACT: Reduces re-renders from N (number of episodes) to 0 during playback toggles.
  */
  return (
