...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: This component renders a list of EpisodeCards. Memoizing it prevents the
     entire list from being re-evaluated when unrelated App state changes.
   - IMPACT: Significant reduction in re-renders for the episode archive page.
*/
const Episodes = memo(function Episodes({ onPlay }: EpisodesProps) {
  return (
