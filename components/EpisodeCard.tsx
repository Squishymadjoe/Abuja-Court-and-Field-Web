...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: This component is rendered many times in the episode list. By memoizing it, we prevent unnecessary re-renders when the parent component (App or Episodes) re-renders due to unrelated state changes (like toggling playback).
   - IMPACT: Combined with stable callbacks in App.tsx, this reduces episode list re-renders from N to 0 during playback toggling.
*/
