...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Prevents the entire Episodes archive from re-rendering when parent state
          changes (e.g., audio playback toggling), as long as its props remain stable.
   - IMPACT: Improves UI responsiveness during global state updates.
*/
