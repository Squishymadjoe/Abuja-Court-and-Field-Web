...
/*
  ...
  - WHAT: Wrapped the EpisodeCard component in React.memo.
  - WHY: As part of a list, each EpisodeCard would otherwise re-render whenever the list container (Episodes) re-renders. Combined with a stable onPlay callback, this allows React to skip re-rendering every card in the list when only the playback state changes.
  - IMPACT: In a list of 6 episodes, this prevents 6 unnecessary re-renders per playback interaction.
*/
