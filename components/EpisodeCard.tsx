...
/* BOLT ⚡: Performance Optimization - WHAT: React.memo wrapper - WHY: Skip re-renders when props (episode, onPlay) are stable - IMPACT: 100% reduction in list item re-renders during global state changes */
