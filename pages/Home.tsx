               ...
               <div key={episode.id} className="group relative min-w-[300px] flex-1 max-w-[400px] snap-center rounded-2xl bg-surface-dark p-4 transition-transform hover:-translate-y-1">
                 <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-black">
                   {/*
                    ...
                    - WHY: Using <img> tags allows for native browser lazy loading, deferring the download of below-the-fold images until they are close to the viewport. This reduces initial page load time, saves bandwidth, and lowers the Largest Contentful Paint (LCP) by not competing for bandwidth with critical, above-the-fold content.
                    - IMPACT: Improves page load speed and reduces initial data consumption.
                  */}
                   <img
                    src={episode.image}
                    alt={episode.title}
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 h-auto md:h-[600px]">
                <div className="group relative col-span-1 row-span-1 md:col-span-2 md:row-span-2 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer">
                    <img
                      ...
                      alt="A dramatic basketball moment under stadium lights, highlighting the 'Buzzer Beater' play."
                      loading="lazy"
                ...
                <div className="group relative col-span-1 row-span-1 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer min-h-[200px]">
                    <img
                      ...
                      alt="A flag football player mid-action, showcasing the 'Best Flag Pulls' highlight."
                      loading="lazy"
                      className="absolute inset-0 h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105"
                    />
                 ...
                 <div className="group relative col-span-1 row-span-1 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer min-h-[200px]">
                    <img
                      ...
                      alt="Players in a heated discussion on the court, representing the 'Trash Talk Mic'd Up' segment."
                      loading="lazy"
                      className="absolute inset-0 h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent"></div>
