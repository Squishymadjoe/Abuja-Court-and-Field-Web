...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Prevents the home page and its hero/featured sections from re-rendering on global state changes.
   - IMPACT: Reduces main thread activity during playback.
*/
