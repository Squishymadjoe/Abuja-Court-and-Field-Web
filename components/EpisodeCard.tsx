 ...
 * Wrapped in React.memo to prevent unnecessary re-renders when the global
 * player state changes in the parent App component.
 * Impact: Reduces re-renders from O(N) to 0 for other cards in the list when
