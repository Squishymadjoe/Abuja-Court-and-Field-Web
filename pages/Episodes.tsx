 ...
 * - WHY: Prevents the entire archive page from re-rendering if App state changes,
 *   as long as props (onPlay) remain stable.
 * - IMPACT: Avoids reconciliation of the large grid and sticky filter bar.
 */
