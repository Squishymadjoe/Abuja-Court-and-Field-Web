...
// - WHY: Prevents individual cards from re-rendering unless their specific episode data or the shared play callback changes.
// - IMPACT: Significantly improves performance of the Episodes grid by limiting renders to only the necessary components.
