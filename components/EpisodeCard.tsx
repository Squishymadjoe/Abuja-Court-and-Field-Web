...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: This component is rendered many times in lists. Memoizing it ensures that
          individual cards only re-render if their specific episode data or the
          onPlay callback (now stabilized with useCallback) changes.
*/
