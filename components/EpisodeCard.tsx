...
const EpisodeCard: React.FC<EpisodeCardProps> = ({ episode, onPlay }) => {
  /*
    ...
    - WHAT: Wrapping EpisodeCard in React.memo.
    - WHY: Prevents re-rendering of individual episode cards when the parent Episodes list re-renders, provided the episode data and onPlay callback remain stable.
  */
  return (
