...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Prevents re-rendering 6+ episode cards every time the parent state (isPlaying) changes, as long as props stay the same
   - IMPACT: Eliminates redundant re-renders for items in the episode list during playback toggle
*/
