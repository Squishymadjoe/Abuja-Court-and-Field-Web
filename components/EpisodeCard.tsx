 ...
 *   when the parent component (App/Episodes) re-renders for reasons unrelated to this card's props
 *   (e.g., when a play event occurs and handlePlayEpisode is called).
 * - IMPACT: Eliminates redundant re-renders for all off-screen and unchanged episode cards.
 */
