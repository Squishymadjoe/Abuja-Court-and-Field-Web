...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Prevents expensive re-renders of individual episode cards in a list when the parent state changes
          but this card's specific data (episode, onPlay callback) remains the same.
*/
