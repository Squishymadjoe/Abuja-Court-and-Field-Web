...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Prevents individual episode cards from re-rendering when the parent list re-renders,
          provided the props (episode and onPlay) remain stable.
   - IMPACT: Reduces re-render overhead for long lists of episodes.
*/
