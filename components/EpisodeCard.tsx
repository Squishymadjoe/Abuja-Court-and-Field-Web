...
/*
   ...
   - WHY: EpisodeCard is a pure component that only depends on its props.
          By memoizing it, we prevent it from re-rendering when the parent
          re-renders unless the 'episode' or 'onPlay' props actually change.
          Combined with stabilized callbacks in the parent, this eliminates
          unnecessary re-renders during playback updates.
   - IMPACT: Reduces re-renders of the episode list by 100% when toggling playback.
*/
