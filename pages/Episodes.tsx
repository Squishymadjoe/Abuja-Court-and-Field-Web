 ...
 * - WHAT: Wrapped Episodes in React.memo.
 * - WHY: Prevents the entire episode list from re-rendering when parent state changes
 *   (like isPlaying or currentEpisode) that are not passed to this component.
 */
