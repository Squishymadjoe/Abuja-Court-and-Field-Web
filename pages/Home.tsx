               ...
               <div key={episode.id} className="group relative min-w-[300px] flex-1 max-w-[400px] snap-center rounded-2xl bg-surface-dark p-4 transition-transform hover:-translate-y-1">
                 <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-black">
                    {/*
                      ...
                      - WHY: Using an <img> tag with `loading="lazy"` allows the browser to defer loading of offscreen images until they are about to enter the viewport. This reduces the initial page load size and saves bandwidth, improving performance, especially on mobile devices.
                      - IMPACT: Faster initial page load and reduced data consumption for users.
                      - MEASUREMENT: Observe the network tab in developer tools; the image requests for episodes further down the scrollable list will only trigger as they are scrolled into view.
                    */}
                   <img
                    src={episode.image}
                    alt={episode.title}
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 h-auto md:h-[600px]">
                <div className="group relative col-span-1 row-span-1 md:col-span-2 md:row-span-2 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer">
                    <img
                      ...
                      alt="Buzzer Beater: Wuse vs Garki"
                      loading="lazy"
