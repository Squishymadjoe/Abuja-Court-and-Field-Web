               ...
               <div key={episode.id} className="group relative min-w-[300px] flex-1 max-w-[400px] snap-center rounded-2xl bg-surface-dark p-4 transition-transform hover:-translate-y-1">
                 <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-black">
                   {/*
                    ...
                    - WHY: Standard `<img>` tags enable native browser lazy loading, which defers the download of off-screen images until the user scrolls near them. This improves initial page load speed by reducing the number of upfront asset requests.
                    - IMPACT: Faster initial page load and reduced initial network payload. Images below the fold won't be loaded until they're needed.
                    - MEASUREMENT: Observe the network tab in browser developer tools. The image requests for these episode cards should only fire as you scroll them into view.
                    */}
                   <img
                    src={episode.image}
                    alt={`Cover art for episode ${episode.episodeNumber}: ${episode.title}`}
                    loading="lazy"
