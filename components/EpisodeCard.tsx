...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: This component is rendered in a list. Memoizing it ensures that individual
          cards only re-render if their props (episode, onPlay) change, which is critical
          when parent state (like playback status) updates.
*/
const EpisodeCard: React.FC<EpisodeCardProps> = React.memo(function EpisodeCard({ episode, onPlay }) {
  console.log(`EpisodeCard RENDER: ${episode.id}`);
  return (
