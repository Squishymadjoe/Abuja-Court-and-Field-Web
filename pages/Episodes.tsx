...
/*
  ...
  - WHY: Prevents unnecessary re-renders when parent state (App) changes but props (onPlay) remain stable.
  - IMPACT: Reduces re-render count for the archive list during audio playback interactions.
*/
