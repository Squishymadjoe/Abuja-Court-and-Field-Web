...
/* BOLT ⚡: Performance Optimization - WHAT: memoized component - WHY: skip re-rendering individual cards - IMPACT: eliminates 12+ redundant renders per interaction - MEASUREMENT: reduces RENDER logs to zero for these items during state changes */
