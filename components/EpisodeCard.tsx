...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: EpisodeCard is a list item that re-renders frequently when parent state changes.
          Memoization ensures it only re-renders if its props (episode or onPlay) change.
   - IMPACT: Significant reduction in re-renders during playback toggling and navigation.
*/
