 ...
 * - WHY: Since the list of episodes is static and the onPlay callback is now stabilized
 *   with useCallback in the parent, memoizing this component prevents all 6 cards
 *   from re-rendering whenever the audio player state (isPlaying) toggles.
 * - IMPACT: Re-renders for the episode list drop from 12 to 0 during playback interaction.
 */
