...
const Home: React.FC<HomeProps> = ({ setPage, onPlay }) => {
  /*
    ...
    - WHAT: Wrapping Home page in React.memo.
    - WHY: Prevents the home page and its expensive hero section from re-rendering unless 'setPage' or 'onPlay' callbacks change.
  */
  return (
