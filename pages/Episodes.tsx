...
const Episodes: React.FC<EpisodesProps> = React.memo(({ onPlay }) => {
  /* BOLT ⚡: Performance Optimization
     - WHAT: Wrapped Episodes page with React.memo.
     - WHY: Prevents the entire episode list and filter section from re-rendering when
       playback state changes in the parent App component.
     - IMPACT: Significantly improves UI responsiveness when starting/pausing episodes.
     - MEASUREMENT: Eliminated Episodes render log during playback toggle.
  */
  return (
