...
/* BOLT ⚡: Performance Optimization - WHAT: Wrapped EpisodeCard in React.memo. - WHY: Prevents the entire episode list from re-rendering when the parent state (like the playback status in the sticky footer) changes. */
