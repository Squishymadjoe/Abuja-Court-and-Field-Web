...
- WHY: Prevents all cards in the list from re-rendering when the parent state (like audio playback) changes, provided their own props remain the same.
- IMPACT: Combined with useCallback in App.tsx, this reduces total renders during playback toggle from 16 to 4.
*/
