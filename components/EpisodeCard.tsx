...
// BOLT ⚡: Performance Optimization - Memoize EpisodeCard to prevent re-renders when parent list re-renders
const EpisodeCard = memo<EpisodeCardProps>(({ episode, onPlay }) => {
  return (
