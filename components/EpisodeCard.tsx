...
const EpisodeCard: React.FC<EpisodeCardProps> = ({ episode, onPlay }) => {
  /*
    ...
    - WHY: This component is rendered in a list. When the parent (Episodes page) re-renders
      (e.g., during a playback state change in App.tsx), React.memo prevents this component
      from re-rendering if its props (episode, onPlay) haven't changed.
    - IMPACT: Combined with stable callbacks in App.tsx, this reduces episode list re-renders from 12 to 0 during playback toggles.
  */
  return (
