...
const EpisodeCard: React.FC<EpisodeCardProps> = React.memo(({ episode, onPlay }) => {
  /* BOLT ⚡: Performance Optimization
     ...
     - WHY: EpisodeCard is a pure component that only depends on its props. By memoizing it, we prevent it from re-rendering when the parent (Episodes page) re-renders, provided its props (episode and onPlay) remain stable.
     - IMPACT: Reduces the number of re-renders in the episode list during state changes in the parent component.
  */
  return (
