...
/*
  ...
  - WHY: EpisodeCard is rendered many times in the Episodes list. By memoizing it,
         we prevent it from re-rendering unless its props (episode or onPlay) actually change.
         This is particularly effective when combined with the useCallback hook used for onPlay in App.tsx.
  - IMPACT: Improves scrolling performance and responsiveness when switching pages or playing/pausing,
            as dozens of components no longer need to be reconciled by React.
*/
