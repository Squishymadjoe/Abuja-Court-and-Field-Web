               ...
               <div key={episode.id} className="group relative min-w-[300px] flex-1 max-w-[400px] snap-center rounded-2xl bg-surface-dark p-4 transition-transform hover:-translate-y-1">
                 <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-black">
                  {/*
                    ...
                    - WHY: Using an <img> tag with `loading="lazy"` defers the download of off-screen images until they are close to the viewport. This reduces initial page load time, saves bandwidth, and improves the Lighthouse performance score by avoiding network requests for unseen images.
                    - IMPACT: Faster initial load, reduced data consumption.
                    - MEASUREMENT: Verify in the browser's network tab that images for episodes further down the list only start loading as you scroll them into view.
                  */}
                   <img
                    src={episode.image}
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 h-auto md:h-[600px]">
                <div className="group relative col-span-1 row-span-1 md:col-span-2 md:row-span-2 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer">
                    <img
                        ...
                        alt="A dramatic, action-shot of a buzzer-beating basketball play in a packed arena."
                        loading="lazy"
                ...
                <div className="group relative col-span-1 row-span-1 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer min-h-[200px]">
                    <img
                        ...
                        alt="Action shot of a player executing a perfect flag pull in a flag football game."
                        loading="lazy"
                        className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105"
                    />
                 ...
                 <div className="group relative col-span-1 row-span-1 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer min-h-[200px]">
                    <img
                        ...
                        alt="Close-up of a basketball player, intensely focused and talking, captioned as 'Trash Talk Mic'd Up'."
                        loading="lazy"
                        className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent"></div>
