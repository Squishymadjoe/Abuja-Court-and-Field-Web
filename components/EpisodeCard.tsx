 ...
 * - WHY: Prevents expensive re-renders of the entire episode list when parent state
 *   (like playback progress) changes, as long as the episode and onPlay props remain stable.
 * - MEASUREMENT: Re-renders for the episode list reduced from 12 to 0 during playback toggle.
 */
