...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Prevents individual card re-renders when the parent (Episodes) re-renders
     or when unrelated state (like the playback toggle) changes.
   - IMPACT: Massive reduction in re-renders for long lists of episodes.
*/
