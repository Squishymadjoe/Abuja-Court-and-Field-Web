...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: This component is rendered many times in a list. Wrapping it with memo prevents it from re-rendering if its props (episode, onPlay) haven't changed.
   - IMPACT: Eliminates redundant renders of every episode card when unrelated state in App (like the global playback state) changes, provided onPlay is also stabilized with useCallback.
*/
