               ...
               <div key={episode.id} className="group relative min-w-[300px] flex-1 max-w-[400px] snap-center rounded-2xl bg-surface-dark p-4 transition-transform hover:-translate-y-1">
                 <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-black">
                  {/*
                    ...
                    - WHY: Images loaded via CSS background-image are not discovered by the browser's preload scanner and can't be deferred. Using a native <img> tag with `loading="lazy"` ensures these below-the-fold images are only downloaded when they are about to enter the viewport.
                    - IMPACT: Improves initial page load time by avoiding unnecessary downloads of off-screen images. Reduces initial network payload.
                    - MEASUREMENT: Observe the network tab in browser developer tools. These images should only start downloading as you scroll down to the "Featured Episodes" section.
                  */}
                   <img
                    src={episode.image}
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 h-auto md:h-[600px]">
                <div className="group relative col-span-1 row-span-1 md:col-span-2 md:row-span-2 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer">
                    <img
                        ...
                        alt="A dramatic shot of a basketball player making a buzzer-beater shot."
                        loading="lazy"
                ...
                <div className="group relative col-span-1 row-span-1 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer min-h-[200px]">
                    <img
                        ...
                        alt="A player making a skillful flag pull in a flag football game."
                        loading="lazy"
                        className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105"
                    />
                 ...
                 <div className="group relative col-span-1 row-span-1 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer min-h-[200px]">
                    <img
                        ...
                        alt="A close-up of players talking intensely during a game."
                        loading="lazy"
                        className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent"></div>
