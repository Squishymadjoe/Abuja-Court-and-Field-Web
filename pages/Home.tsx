               ...
               <div key={episode.id} className="group relative min-w-[300px] flex-1 max-w-[400px] snap-center rounded-2xl bg-surface-dark p-4 transition-transform hover:-translate-y-1">
                 <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-black">
                    {/*
                      ...
                      - WHY: The browser can't prioritize or lazy-load CSS background images. Switching to an <img> tag with `loading="lazy"` tells the browser to only download this image when it's about to enter the viewport, saving bandwidth and speeding up initial page load.
                      - IMPACT: Reduces initial network requests and improves Largest Contentful Paint (LCP) if other elements are prioritized.
                    */}
