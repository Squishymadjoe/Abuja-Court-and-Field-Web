...
const EpisodeCard = React.memo(({ episode, onPlay }: EpisodeCardProps) => {
  ...
  // - WHY: Prevents the component from re-rendering unless its props (episode or onPlay) change.
  //   In combination with a stable onPlay callback, this eliminates redundant renders when
  //   the user interacts with other parts of the UI or other episodes.
  return (
...
// BOLT ⚡: Set display name for easier debugging with memo
