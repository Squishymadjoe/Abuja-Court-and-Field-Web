...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Episode cards are repeated elements in a list. When the audio player
     state changes in the parent, all episode cards would normally re-render.
     React.memo ensures each card only re-renders if its specific episode data
     or the onPlay callback changes.
*/
