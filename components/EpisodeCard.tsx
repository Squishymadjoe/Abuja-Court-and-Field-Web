...
const EpisodeCard: React.FC<EpisodeCardProps> = React.memo(({ episode, onPlay }) => {
  /*
    ...
    - WHY: Prevents individual cards from re-rendering when the parent list re-renders, provided props haven't changed.
    - IMPACT: Works in tandem with stable onPlay callback to eliminate unnecessary re-renders during player state updates.
  */
  return (
