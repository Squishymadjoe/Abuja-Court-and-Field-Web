               ...
               <div key={episode.id} className="group relative min-w-[300px] flex-1 max-w-[400px] snap-center rounded-2xl bg-surface-dark p-4 transition-transform hover:-translate-y-1">
                 <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-black">
                  {/*
                    ...
                    - WHY: Standard <img> tags enable native browser lazy loading, which defers the download of off-screen images until the user scrolls near them. This reduces initial page load time, saves bandwidth, and improves Core Web Vitals.
                    - IMPACT: Faster initial page load and reduced data consumption for users who don't scroll down.
                    - MEASUREMENT: Observe the network tab in browser developer tools; images for episodes should only load as you scroll them into view.
                  */}
                   <img
                    src={episode.image}
                    alt={episode.title}
