...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Prevents individual episode cards from re-rendering when the parent list or global state changes, provided their props haven't changed.
   - IMPACT: Dramatically reduces the number of component re-renders during playback interactions.
*/
