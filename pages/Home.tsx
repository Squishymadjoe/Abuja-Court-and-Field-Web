    ...
    <div className="relative flex w-full flex-col">
      ...
      <section className="relative flex min-h-[90vh] w-full flex-col items-center justify-center overflow-hidden px-4 pt-20 pb-12">
        <div className="absolute inset-0 z-0">
          {/*
            Optimization: Replaced a div with a CSS background image with a native <img> tag.
            - This image is the main hero image and is critical for the initial viewport (Largest Contentful Paint).
            - It is intentionally loaded eagerly (no `loading="lazy"`) to ensure the fastest possible render of above-the-fold content.
          */}
          <img
            ...
            alt="Abuja basketball court scene"
             ...
             {EPISODES.slice(0, 4).map((episode) => (
               <div key={episode.id} className="group relative min-w-[300px] flex-1 max-w-[400px] snap-center rounded-2xl bg-surface-dark p-4 transition-transform hover:-translate-y-1">
                 <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-black">
                  {/*
                    Optimization: Replaced a div with a CSS background image with a native <img> tag.
                    - `loading="lazy"` defers loading of episode images until they are scrolled into view.
                    - This is crucial for performance on pages with many images, like this featured section.
                  */}
                   <img src={episode.image} alt={episode.title} loading="lazy" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-110" />
