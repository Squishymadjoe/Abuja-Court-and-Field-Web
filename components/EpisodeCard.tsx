...
// - WHAT: Memoized the EpisodeCard component using React.memo.
// - WHY: Prevents individual episode cards from re-rendering when their parent list (Episodes)
//   re-renders, unless their specific props (episode, onPlay) change.
