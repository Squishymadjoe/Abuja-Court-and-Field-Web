...
// - WHY: Prevents the entire episodes list from re-rendering when App state (like isPlaying)
//        changes, as long as the onPlay callback remains stable.
const Episodes = React.memo(({ onPlay }: EpisodesProps) => {
  return (
