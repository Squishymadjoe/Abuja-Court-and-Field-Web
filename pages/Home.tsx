 ...
 * - WHAT: Wrapped Home in React.memo.
 * - WHY: Prevents the hero section and featured content from re-rendering during
 *   state updates in the parent App component (like toggling playback).
 */
