...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Prevents unnecessary re-renders of the episode card when parent state changes but its own props remain identical.
   - IMPACT: Significant reduction in re-renders during playback interactions.
*/
