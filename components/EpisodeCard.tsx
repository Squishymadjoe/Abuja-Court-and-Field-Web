...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Skips expensive re-renders of list items when the parent list is stable.
   - IMPACT: Eliminates redundant renders of all episodes in the archive on every player interaction.
*/
