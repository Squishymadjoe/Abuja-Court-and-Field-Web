 ...
 * - WHY: EpisodeCard is rendered frequently in lists. Since its props (episode and onPlay)
 *   are now stable, memoization prevents re-renders when the parent (App) re-renders
