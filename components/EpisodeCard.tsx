...
const EpisodeCard = React.memo(function EpisodeCard({ episode, onPlay }: EpisodeCardProps) {
  /* BOLT ⚡: Performance Optimization
     ...
     - WHY: Prevents individual episode cards from re-rendering when parent components or states change, as long as the episode data and onPlay callback are stable.
     - IMPACT: Reduces re-render count by N (number of episodes) when toggling playback.
  */
  return (
