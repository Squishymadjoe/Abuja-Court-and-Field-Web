        ...
        <div className="mx-auto max-w-7xl px-4 relative z-10">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 h-auto md:h-[600px]">
                <div className="group relative col-span-1 row-span-1 md:col-span-2 md:row-span-2 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer">
                    <img loading="lazy" decoding="async" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDmamKQFLSBU9m3x4-xX6aQt5abN6S1n9T6X6OxcH8MjRN8xLvIIRTJP64dLS4F2O5bZucfV-ehPKsc_sqE8WD8BeZaNvOjwRUTrgFR8nDHe6PQPajMK0ZHatQpwWPRXhXJw2LO6qKnlX6gDlTT51GyxwyfnwVsJJ78-8uWpgT2ZMH_fEil7Q7lZp7jhruZUevPFcAZZ5BgF9k5cwviL7HtMHNzhaMx0x3XAHAyIggD18fXQ0pgOzGLxa--wbUuLsBkn-GCWPqSChv1" alt="A dramatic basketball moment under the lights, capturing a buzzer-beater shot." className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105" />
                ...
                <div className="group relative col-span-1 row-span-1 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer min-h-[200px]">
                    <img loading="lazy" decoding="async" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCBhYMgT980sblmLf4LiVl7TQfo9QqEAFTcmV4sx5jbEfN8mtRChux1sQwH6XUdXajig9ixZtS8jTAtCICdeNfkocJ0B31T_OqQJh9zpMFh_AW8nvW4bVLejZUiosSlmbtgHAO00Xt6_segxM1ivQ5LJ5iBIFwF8YyhfVZAdAAMTbePaxk58Lon3SLOMpnnZ6xB0rBmmVnNbopT2wIFKYoijIJpbqND0Wr2Y63NG7LXGpT5d0NzCjaha5SP0rq0lLlg2B4evSDXilg1" alt="A flag football player executing a perfect flag pull on an opponent." className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105" />
                 ...
                 <div className="group relative col-span-1 row-span-1 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer min-h-[200px]">
                    <img loading="lazy" decoding="async" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBtSkX3RrqjEjkK6-bw68YlCskmFoa1h07IJqu_2_GU7V5p8lLEesk4mlq0JTf7cqXIrIr5NpZ2bBXSa4hnJuB5a7LLhP9MNEHHyvl0P1t4mEG0twRS2NxjV_azoaLg_Pgt-0KWY69tU6iu83fg78kiG9UkMo9gUWnKWNBn759CJKTb8D4W4c3d07zB9QnywpdLZ2k-weQ4M8xBHxGdItOtuWQBB94AseGWw8NNDPE_VuxX3tX-RHAy54g3WltWyxg-wH5aevUuUmEb" alt="Two basketball players engaged in intense, good-natured trash talk during a game." className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent"></div>
                    <div className="absolute bottom-0 left-0 p-6">
