...
/*
  ...
  - WHAT: Wrapped Contact component in React.memo.
  - WHY: Prevents the Contact page from re-rendering when App state changes.
  - IMPACT: Improves UI stability and reduces CPU usage.
*/
