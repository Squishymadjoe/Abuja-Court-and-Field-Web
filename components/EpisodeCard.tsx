...
const EpisodeCard: React.FC<EpisodeCardProps> = React.memo(function EpisodeCard({ episode, onPlay }) {
  /* BOLT ⚡: Performance Optimization - WHAT: React.memo() - WHY: Prevent re-renders when parent list changes - IMPACT: Reduces redundant renders of list items by 100% when playback state changes */
  return (
