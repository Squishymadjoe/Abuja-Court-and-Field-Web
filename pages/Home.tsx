               ...
               <div key={episode.id} className="group relative min-w-[300px] flex-1 max-w-[400px] snap-center rounded-2xl bg-surface-dark p-4 transition-transform hover:-translate-y-1">
                 <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-black">
                    {/*
                      ...
                      - WHY: Standard `<img>` tags enable native browser features like lazy loading. By setting `loading="lazy"`, we defer the loading of these offscreen images until the user scrolls near them.
                      - IMPACT: This reduces initial page load time, lowers the amount of data downloaded upfront, and decreases initial memory usage. It's especially beneficial for users on slower networks or less powerful devices.
                      - MEASUREMENT: Verify using the Network tab in browser developer tools. Filter by "img" and observe that these episode images are only fetched as you scroll them into the viewport.
                    */}
                    <img
                      src={episode.image}
