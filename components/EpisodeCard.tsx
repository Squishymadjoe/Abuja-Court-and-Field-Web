...
/*
  ...
  - WHY: Prevents individual episode cards from re-rendering unless their specific props (episode or onPlay) change.
    In conjunction with stable parent callbacks, this eliminates re-renders during playback state updates.
  - IMPACT: Reduces the render count of the episode list from N to 0 when toggling play/pause.
*/
