 ...
 * - WHY: Prevents expensive re-renders of list items when the parent container updates
 *   but this specific item's data hasn't changed.
 * - IMPACT: Combined with stable parent callbacks, this reduces episode list re-renders to 0 during playback state changes.
 */
