...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: Prevents the entire episode list from re-rendering when parent state changes but the page props are stable.
   - IMPACT: Improves UI responsiveness during audio playback.
*/
