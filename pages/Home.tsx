...
/*
  ...
  - WHY: Prevents unnecessary re-renders of the hero section and featured list when App's state (like isPlaying) changes.
  - IMPACT: Optimized rendering for the main landing experience.
*/
