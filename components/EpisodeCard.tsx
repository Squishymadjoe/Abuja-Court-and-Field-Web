...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: In a long list of episodes, this prevents each card from re-rendering unless its specific episode data or the play callback changes. Since onPlay is memoized in App.tsx, cards remain stable.
*/
