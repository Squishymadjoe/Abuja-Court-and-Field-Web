 ...
 * - WHY: Prevents expensive re-renders of list items when the parent list re-renders
 *   due to unrelated state changes (like audio playback toggling).
 * - IMPACT: Eliminates redundant re-renders for all episodes in the list.
 */
