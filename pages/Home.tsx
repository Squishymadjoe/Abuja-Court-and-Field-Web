             ...
             {EPISODES.slice(0, 4).map((episode) => (
               <div key={episode.id} className="group relative min-w-[300px] flex-1 max-w-[400px] snap-center rounded-2xl bg-surface-dark p-4 transition-transform hover:-translate-y-1">
                 <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-black">
                    {/*
                      BOLT ⚡: Performance Optimization
                      - WHAT: Replaced a CSS background-image with an <img> tag for episode cards.
                      - WHY: The browser can discover and load <img> tags much earlier than CSS backgrounds. For these below-the-fold images, adding `loading="lazy"` defers their download until the user scrolls near them, improving initial page load time and reducing initial network payload.
                      - IMPACT: Improves Largest Contentful Paint (LCP) and reduces initial page weight by preventing off-screen images from loading unnecessarily.
                    */}
                    <img
                      src={episode.image}
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-2 h-auto md:h-[600px]">
                <div className="group relative col-span-1 row-span-1 md:col-span-2 md:row-span-2 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer">
                    {/*
                      ...
                      - WHY: Using a native <img> tag with `loading="lazy"` allows the browser to defer loading this image until it's needed, improving initial page load speed.
                      - IMPACT: Faster LCP and reduced initial data consumption.
                    */}
                    <img
                      ...
                      alt="A dramatic wide-shot of a basketball player hitting a buzzer-beater."
                      loading="lazy"
                ...
                <div className="group relative col-span-1 row-span-1 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer min-h-[200px]">
                    <img
                      ...
                      alt="A flag football player mid-action, pulling a flag from an opponent."
                      loading="lazy"
                      className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105"
                    />
                 ...
                 <div className="group relative col-span-1 row-span-1 overflow-hidden rounded-3xl bg-surface-dark cursor-pointer min-h-[200px]">
                    <img
                      ...
                      alt="Close-up of two basketball players talking trash mid-game."
                      loading="lazy"
                      className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent"></div>
