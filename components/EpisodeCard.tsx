...
const EpisodeCard: React.FC<EpisodeCardProps> = React.memo(({ episode, onPlay }) => {
  /* BOLT ⚡: Performance Optimization
     ...
     - WHY: This component is rendered in a list. Wrapping it in React.memo prevents
       unnecessary re-renders when the parent component re-renders but the props
       (episode and onPlay) remain the same.
     - IMPACT: Reduces the number of renders significantly when global state (like playback) changes.
  */
  return (
