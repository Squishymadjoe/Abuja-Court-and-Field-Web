...
/* BOLT ⚡: Performance Optimization
   ...
   - WHY: EpisodeCard is rendered many times in the archive list.
   - IMPACT: Prevents re-rendering of each card when parent state (like playback status) changes but the card's props remain identical.
*/
