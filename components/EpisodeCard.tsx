...
const EpisodeCard: React.FC<EpisodeCardProps> = ({ episode, onPlay }) => {
  /*
    ...
    - WHY: Prevents individual episode cards from re-rendering when parent state (like 'isPlaying') changes, as long as the 'onPlay' callback is stable and the 'episode' data remains the same.
    - IMPACT: In a list of 10+ episodes, this eliminates dozens of unnecessary render calls per state change.
  */
  return (
